...
def reconstruct(dataset_dir, model_path, e2vid_model_path, save_path):
    ...
    e2vid = load_model(e2vid_model_path, device)
    e2vid.eval()
    e2vid.to(device)
...
if __name__ == "__main__":
    ...
    print("CNN model path:          ", model_path)
    print("E2VID model path:        ", e2vid_model_path)
    print("Save path:               ", save_path)
    print("----------------------------------")

    #Train 
    reconstruct(dataset_dir, model_path, e2vid_model_path, save_path)
